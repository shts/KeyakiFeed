...
public class PermissionRequireActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            urlList = savedInstanceState.getStringArrayList(ExtraKey.DOWNLOAD);
        } else {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        outState.putStringArrayList(ExtraKey.DOWNLOAD, urlList);
    ...
    private void showRationalDialog(final PermissionRequest request) {
        new AlertDialog.Builder(this)
                .setMessage("画像ダウンロードにはストレージへのアクセスが必要です")
